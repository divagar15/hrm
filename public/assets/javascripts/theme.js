  ...
  */
  ...
  $(document).ready(function() {
    ...
    */
    ...
    //setDataTable($(".data-table-column-filter-lead"));
    /*
    * --------------------------------------------------------------------------------------------------------------------
    ...
    */
    ...
    if (jQuery().datetimepicker) {
      ...
      $(".datepicker-input-followup").datetimepicker({
        startDate: new Date() ,
        pickTime: true,
    ...
    if (jQuery().dataTable) {
      return selector.each(function(i, elem) {
        ...
        if ($(elem).hasClass("data-table-column-filter")) {
          //return dt.columnFilter({ sPlaceHolder: "head:after", aoColumns: [ null, null, null, null,{ type: "select" }, null,{ type: "select" },null,null ] });
