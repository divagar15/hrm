                ...
                <div class="row">
                  <div class='col-sm-12'>
                      ...
                      <div class='box-header blue-background'>
                        <div class='title'>Edit Allowance</div>
                      </div>
                      <div class='box-content'>
                        <form class='form form-horizontal validate-form' action="{{ URL::to('employee/config/edit-allowance/'.$id) }}" name="frmallowance" id="frmallowance" method="post" style='margin-bottom: 0;'>
                          <div class='form-group'>
                             <label class='control-label col-sm-3' for='name'>Allowance</label>
                             <div class='col-sm-6 controls'>
                               <input type="hidden" name="coa_id" id="coa_id" value="{{ $view->fkcoa_id }}">
                               <input class="form-control" data-rule-required='true' data-rule-minlength="2"  id='name' name='name' type='text' value="{{ $view->allowance }}">
                             </div>
                          </div>
