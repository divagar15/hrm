                ...
                <div class="row">
                  <div class='col-sm-12'>
                      ...
                      <div class='box-content'>
                        <form class='form form-horizontal validate-form' action="{{ URL::to('leave/add-holiday') }}" name="frmholiday" id="frmholiday" method="post" style='margin-bottom: 0;'>
                          <div class='form-group'>
                             <label class='control-label col-sm-3' for='holiday_name'>Holiday Name</label>
                             <div class='col-sm-6 controls'>
                               <input class="form-control" data-rule-required='true' data-rule-minlength="2"  id='holiday_name' name='holiday_name' placeholder='Holiday Name' type='text' value="{{-- $fee_list->fee_type --}}">
                             </div>
                          </div>
                          <div class='form-group'>
                          ...
                          <div class='form-group'>
                             ...
                             <div class='col-sm-6 controls input-group'>
                               <input class='form-control datepicker' data-rule-required='true' id='holiday_date' name='holiday_date' data-format="DD-MM-YYYY"  placeholder='DD-MM-YYYY' type='text' value="">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3">
                                      <div class="btn-toolbar" id="edit-mode">
                                          <button class="btn-primary btn" type="submit" id="add-btn">Add Holiday</button>
                                      </div>
                                    </div>
                                  </div>
                           </div>
