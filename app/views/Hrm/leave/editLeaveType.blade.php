                ...
                <div class="row">
                  ...
                  @if(Session::has('successalert'))
                      ...
                      <div class='box-header blue-background'>
                        <div class='title'>Edit Leave Type</div>
                      </div>
                      <div class='box-content'>
                        <form class='form form-horizontal validate-form' action="{{ URL::to('leave/edit-leave-type/'.$id) }}" name="frmholiday" id="frmholiday" method="post" style='margin-bottom: 0;'>
                          <div class='form-group'>
                             <label class='control-label col-sm-3' for='holiday_name'>Leave Type</label>
                             <div class='col-sm-6 controls'>
                               <input class="form-control" data-rule-required='true' data-rule-minlength="2"  id='leave_type' name='leave_type' type='text' value="{{ $view_leave->leave_type }}">
                             </div>
                          </div>
                          <div class='form-group'>
                             <label class='control-label col-sm-3' for='leave_count'>No of days leave</label>
                             <div class='col-sm-6 controls'>
                               <input class="form-control" data-rule-required='true' data-rule-minlength="1"  id='leave_count' name='leave_count' placeholder='No of days Leave' type='text' value="{{ $view_leave->leave_count }}">
                             </div>
                          </div>
