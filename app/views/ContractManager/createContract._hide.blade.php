                                                                  ...
                                                                  <table class="table table-striped table-hover table-bordered">
                                                                    ...
                                                                    <tbody>
                                                                      <tr>                                                                       
                                                                        ...
                                                                        <td>
                                                                          <div class="col-sm-12">
                                                                            <input class='form-control text-right' id='f_paid_admin_fee_val' name='f_paid_admin_fee_val'  value='0' data-rule-required="true" placeholder='' type='text' />
                                                                          </div>
                                                                        </td>                                                                        
                                                                      </tr>
                                                                      <tr>                                                                       
                                                                        ...
                                                                        <td>
                                                                          <div class="col-sm-12">
                                                                            <input class='form-control text-right' id='f_paid_ins_fee_val' name='f_paid_ins_fee_val'  value='0' data-rule-required="true" placeholder='' type='text' />
                                                                          </div>
                                                                        </td>                                                                        
                                                                      </tr>
                                                                      <tr>                                                                        
                                                                        ...
                                                                        <td>
                                                                          <div class="col-sm-12">
                                                                            <input class='form-control text-right' id='f_paid_agency_fee_val' name='f_paid_agency_fee_val'  value='0' data-rule-required="true" placeholder='' type='text' />
                                                                          </div>
                                                                        </td>                                                                        
                                                                      </tr>
                                                                      <tr>
                                                                        ...
                                                                        <td>
                                                                          <div class="col-sm-12">
                                                                            <input class='form-control text-right' id='f_paid_total' name='f_paid_total'  value='0' data-rule-required="true" placeholder='' type='text' readonly/>
                                                                          </div>
                                                                        </td>
...
<!--                                                                         <div class="form-group">
                                                        ...
                                                        <div class='form-group'>
                                                          ...
                                                          <div class='form-group'>
                                                               ...
                                                               <div class='controls col-sm-6' id="feetypes">
                                                                   ...
                                                                   ?>
                                                                   <label  class="control-label">{{  trim($feeList,',') /*CommonFunction::displayFeeCollected($resultStatus->paid_admin_fee,$resultStatus->paid_ins_fee,$resultStatus->paid_agency_fee)*/ }}</label>
                                                               </div>
                                                           </div>
                                                           <div class="form-group">
                                                               <label class='control-label col-sm-3' for='from_date'>Contract Schedule From Date</label>
                                                       ...
                                                       <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                @if($lastInvoiceInfo->fee_collect_status == 0)
                                                                ...
                                                                <table width="100%" border="1">
                                                                    <tr>
                                                                        ...
                                                                        <th width="10%" style="text-align:center;">Pay Mode</th>
                                                                        <th>Fee Collected</th>
                                                                        <th>Target Fee</th>
                                                                        <th>Paid Amt</th>
                                                                        <th>Balance Amt</th>
                                                                    ...
                                                                    ?>
                                                                      @foreach($invoice_list as $key => $list)
                                                                        <?php $feeList= ''; 
                                                                            ...
                                                                            $admin_fee += $list->paid_admin_fee;
                                                                            $insurance_fee += $list->paid_ins_fee;
                                                                            $agency_fee += $list->paid_agency_fee;
                                                                        ?>
                                                                    <tr>
                                                                        ...
                                                                        <td align="center">@if($list->pay_mode==1) {{ "Cash" }} @elseif ($list->pay_mode==2) {{ "Cheque" }} @endif</td>
                                                                        <td>{{ /*trim($feeList,',')*/  CommonFunction::displayFeeCollected($list->paid_admin_fee,$list->paid_ins_fee,$list->paid_agency_fee) }}</td>
                                                                    ...
                                                                    @endforeach
                                                                    <tr>
                                                                        <td colspan="6" align="right">Total Fee Collected</td>
                                                                        <td colspan="2" align="left">{{ '$'.number_format($totalAmt,2) }}</td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                       </div>
                                                       ...
                                                       ?>
                                                       @if(!empty($invoice_list) && $lastInvoiceInfo->fee_collect_status == 0) 
                                                                                  ...
                                                                                  <form class="form validate-form" style="margin-bottom: 0;" method="post" action="{{ URL::to('contract/balance-payment') }}" accept-charset="UTF-8">
                                                                                    ...
                                                                                    <div class='modal-body'>
                                                                                       ...
                                                                                       <div class="form-group">
                                                                                            ...
                                                                                            <input class='form-control' id='paid_amt' name='paid_amt'  data-rule-required="true" placeholder='Paid Amt' type='text' value="{{ $totalAmt }}" readonly="readonly"/>                                                                                        </div> 
                                                                                       <div class="form-group">
                                                                                                 ...
                                                                                                 <table class="table table-striped table-hover table-bordered">
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                      <tr>                                                                       
                                                                                                        ...
                                                                                                        <td>
                                                                                                          <div class="col-sm-12">
                                                                                                            <input class='form-control text-right' id='bal_admin_fee_val' name='bal_admin_fee_val'  value="{{ $lastInvoiceInfo->bal_admin_fee }}" data-rule-required="true" placeholder='' type='text' readonly />
                                                                                                          </div>
                                                                                                        </td>
                                                                                                        <td>
                                                                                                          <div class="col-sm-12">
                                                                                                      ...
                                                                                                      <tr>                                                                       
                                                                                                        ...
                                                                                                        <td>
                                                                                                          <div class="col-sm-12">
                                                                                                            <input class='form-control text-right' id='bal_ins_fee_val' name='bal_ins_fee_val'  value="{{ $lastInvoiceInfo->bal_ins_fee }}" data-rule-required="true" placeholder='' type='text' readonly/>
                                                                                                          </div>
                                                                                                        </td>
                                                                                                        <td>
                                                                                                          <div class="col-sm-12">
                                                                                                      ...
                                                                                                      <tr>                                                                        
                                                                                                        ...
                                                                                                        <td>
                                                                                                          <div class="col-sm-12">
                                                                                                            <input class='form-control text-right' id='bal_agency_fee_val' name='bal_agency_fee_val'  value="{{ $lastInvoiceInfo->bal_agency_fee }}" data-rule-required="true" placeholder='' type='text' readonly />
                                                                                                          </div>
                                                                                                        </td>
                                                                                                        <td>
                                                                                                          <div class="col-sm-12">
                                                                                      ...
                                                                                      <div class="form-group cheque-info">
                                                                                          <label class='control-label' for='cheque_date'>Cheque Date</label>
                                                                                           <div class='controls input-group' id="chequedate">
                                                                                                <input class='form-control datepicker-input' id='cheque_date' name='cheque_date'  data-rule-required="true" data-format="YYYY-MM-DD"  placeholder='YYYY-MM-DD' type='text' /> 
                                                                                                <span class="input-group-addon">
                                                                                                 <span class="icon-calendar" data-time-icon="icon-time" data-date-icon="icon-calendar"></span>
                                                                                                </span>
                                                                                           </div>
                                                                                    ...
                                                                                    <div class='modal-body'>
                                                                                       ...
                                                                                       <div class='form-group loan-opt'>
                                                                                         <label class='control-label ' for='loan_amount'>Repayment Date</label>
                                                                                             <div class='controls   input-group'>
                                                                                                 <input class='form-control datepicker-input' id='repay_date' name='repay_date'  data-rule-required='true' data-rule-minlength='2' data-format="YYYY-MM-DD"  placeholder='YYYY-MM-DD' type='text' />
                                                                                                     <span class='input-group-addon'>
                                                                                                         <span class='icon-calendar' data-time-icon='icon-time' data-date-icon='icon-calendar'></span>
                                                                                                     </span>
                                                                                             </div>
